...
def str_to_read():  # This function is established to create four players with string cards in their hands.
    ...
    for card in h4ranksuit:
        print(card)
    htotal=h1ranksuit+h2ranksuit+h3ranksuit+h4ranksuit
    return htotal
    # for card in htotal:
    #     print(card)
    # print(type(htotal))
...
def main():
    ...
    file_name = str(str(htotal[1]) + '.' + 'png')
    ...
    file_name = str(str(htotal[5]) + '.' + 'png')
    ...
    file_name = str(str(htotal[6]) + '.' + 'png')
    ...
    file_name = str(str(htotal[7]) + '.' + 'png')
